...
const Dashboard = () => {
  ...
  const onSubmit = (data) => {
    ...
    axios
      .post("https://task-manager-server-pi-self.vercel.app/addtasks", taskData)
      .then((res) => {
        console.log(res);
        refectch();
        setShowModal(false);
  ...
  return (
    <div className=" lg:p-[30px] md:p-[20px] p-2">
      ...
      {showModal ? (
        <div className="fixed  inset-0 z-50 flex items-center text-black justify-center overflow-x-hidden overflow-y-auto outline-none focus:outline-none">
